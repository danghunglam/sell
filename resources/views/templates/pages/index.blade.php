...
@section('content')
	...
	<section class="slide1">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1 item1-slick1" style="background-image: url({{ asset('assets/images/master-slide-07.jpg') }});">
				...
				<div class="item-slick1 item2-slick1" style="background-image: url({{ asset('assets/images/master-slide-06.jpg') }});">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
				...
				<div class="item-slick1 item3-slick1" style="background-image: url({{ asset('assets/images/master-slide-02.jpg') }});">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
					...
					<div class="tab-pane fade show active" id="best-seller" role="tabpanel">
						<div class="row">
							...
							<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
								...
								<div class="block2">
									<div class="block2-img wrap-pic-w of-hidden pos-relative">
										<img src="{{ asset('assets/images/item-08.jpg') }}" alt="IMG-PRODUCT">
							...
							<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
								...
								<div class="block2">
									<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelsale">
										<img src="{{ asset('assets/images/item-06.jpg') }}" alt="IMG-PRODUCT">
							...
							<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
								...
								<div class="block2">
									<div class="block2-img wrap-pic-w of-hidden pos-relative">
										<img src="{{ asset('assets/images/item-12.jpg') }}" alt="IMG-PRODUCT">
							...
							<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
								...
								<div class="block2">
									<div class="block2-img wrap-pic-w of-hidden pos-relative">
										<img src="{{ asset('assets/images/item-14.jpg') }}" alt="IMG-PRODUCT">
					...
					<div class="tab-pane fade" id="featured" role="tabpanel">
						<div class="row">
							...
							<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
								...
								<div class="block2">
									<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
										<img src="{{ asset('assets/images/item-01.jpg') }}" alt="IMG-PRODUCT">
							...
							<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
								...
								<div class="block2">
									<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelsale">
										<img src="{{ asset('assets/images/item-11.jpg') }}" alt="IMG-PRODUCT">
							...
							<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
								...
								<div class="block2">
									<div class="block2-img wrap-pic-w of-hidden pos-relative">
										<img src="{{ asset('assets/images/item-15.jpg') }}" alt="IMG-PRODUCT">
